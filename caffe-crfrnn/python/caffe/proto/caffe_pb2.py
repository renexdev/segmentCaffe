...
_LAYERPARAMETER_LAYERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MULTI_STAGE_MEANFIELD', index=26, number=42,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SIMPLE_FAST_MEANFIELD', index=35, number=41,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_LAYERPARAMETER_DIMCHECKMODE = _descriptor.EnumDescriptor(
  name='DimCheckMode',
...
_MULTISTAGEMEANFIELDPARAMETER_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='caffe.MultiStageMeanfieldParameter.Mode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='POTTS', index=0, number=0,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='multi_stage_meanfield_param', full_name='caffe.LayerParameter.multi_stage_meanfield_param', index=29,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='power_param', full_name='caffe.LayerParameter.power_param', index=33,
      number=21, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='relu_param', full_name='caffe.LayerParameter.relu_param', index=34,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sigmoid_param', full_name='caffe.LayerParameter.sigmoid_param', index=35,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='softmax_param', full_name='caffe.LayerParameter.softmax_param', index=36,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='slice_param', full_name='caffe.LayerParameter.slice_param', index=37,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tanh_param', full_name='caffe.LayerParameter.tanh_param', index=38,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='threshold_param', full_name='caffe.LayerParameter.threshold_param', index=39,
      number=25, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='window_data_param', full_name='caffe.LayerParameter.window_data_param', index=40,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='transform_param', full_name='caffe.LayerParameter.transform_param', index=41,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='loss_param', full_name='caffe.LayerParameter.loss_param', index=42,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='layer', full_name='caffe.LayerParameter.layer', index=43,
...
_MULTISTAGEMEANFIELDPARAMETER = _descriptor.Descriptor(
  name='MultiStageMeanfieldParameter',
  full_name='caffe.MultiStageMeanfieldParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='compatibility_mode', full_name='caffe.MultiStageMeanfieldParameter.compatibility_mode', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='threshold', full_name='caffe.MultiStageMeanfieldParameter.threshold', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='theta_alpha', full_name='caffe.MultiStageMeanfieldParameter.theta_alpha', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='theta_beta', full_name='caffe.MultiStageMeanfieldParameter.theta_beta', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='theta_gamma', full_name='caffe.MultiStageMeanfieldParameter.theta_gamma', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_iterations', full_name='caffe.MultiStageMeanfieldParameter.num_iterations', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='spatial_filter_weight', full_name='caffe.MultiStageMeanfieldParameter.spatial_filter_weight', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bilateral_filter_weight', full_name='caffe.MultiStageMeanfieldParameter.bilateral_filter_weight', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='forced_spatial_filter_weight', full_name='caffe.MultiStageMeanfieldParameter.forced_spatial_filter_weight', index=8,
      number=9, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='forced_bilateral_filter_weight', full_name='caffe.MultiStageMeanfieldParameter.forced_bilateral_filter_weight', index=9,
      number=10, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _MULTISTAGEMEANFIELDPARAMETER_MODE,
  ],
  options=None,
  is_extendable=False,
  extension_ranges=[],
...
_LAYERPARAMETER.fields_by_name['multi_stage_meanfield_param'].message_type = _MULTISTAGEMEANFIELDPARAMETER
...
_MULTISTAGEMEANFIELDPARAMETER.fields_by_name['compatibility_mode'].enum_type = _MULTISTAGEMEANFIELDPARAMETER_MODE
_MULTISTAGEMEANFIELDPARAMETER_MODE.containing_type = _MULTISTAGEMEANFIELDPARAMETER;
...
DESCRIPTOR.message_types_by_name['MultiStageMeanfieldParameter'] = _MULTISTAGEMEANFIELDPARAMETER
...
class MultiStageMeanfieldParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _MULTISTAGEMEANFIELDPARAMETER
